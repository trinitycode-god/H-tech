...
function validarFormulario() {
  ...
  // Lote, Validade e Nota fiscal são opcionais — sem validação de obrigatoriedade,
  // apenas garante que nenhum estado de erro antigo fique preso no campo.
  setFeedback(feedbackParaCampo("lote"), "", null);
  setInputState(el.lote, null);
  setFeedback(feedbackParaCampo("validade"), "", null);
  setInputState(el.validade, null);
  setFeedback(feedbackParaCampo("notaFiscal"), "", null);
  setInputState(el.notaFiscal, null);
